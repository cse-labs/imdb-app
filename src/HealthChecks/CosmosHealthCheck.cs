...
namespace Imdb.Application
{
    ...
    {
        public static readonly string ServiceId = "IMDb";
        public static readonly string Description = "IMDb Health Check";
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
        {
            ...
            {
                // log and return unhealthy
                logger.LogError($"Exception:Healthz:{ex.Message}");
